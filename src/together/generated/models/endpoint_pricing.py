...
class EndpointPricing(BaseModel):
    ...
    cents_per_minute: Union[StrictFloat, StrictInt] = Field(
        description="Cost per minute of endpoint uptime in cents"
    )
    __properties: ClassVar[List[str]] = ["cents_per_minute"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"cents_per_minute": obj.get("cents_per_minute")})
        return _obj
