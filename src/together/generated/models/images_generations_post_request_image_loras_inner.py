...
class ImagesGenerationsPostRequestImageLorasInner(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"path": obj.get("path"), "scale": obj.get("scale")})
        return _obj
