...
class CompletionResponse(BaseModel):
    ...
    id: StrictStr
    choices: List[CompletionChoicesDataInner]
    prompt: Optional[List[PromptPartInner]] = None
    usage: UsageData
    created: StrictInt
    model: StrictStr
    object: StrictStr
        ...
        _obj = cls.model_validate(
            {
                ...
                "choices": (
                    [
                        CompletionChoicesDataInner.from_dict(_item)
                        for _item in obj["choices"]
                    ]
                    if obj.get("choices") is not None
                    else None
                ),
                "prompt": (
                    [PromptPartInner.from_dict(_item) for _item in obj["prompt"]]
