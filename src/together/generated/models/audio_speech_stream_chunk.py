...
class AudioSpeechStreamChunk(BaseModel):
    ...
    object: StrictStr
    model: StrictStr
    b64: StrictStr = Field(description="base64 encoded audio stream")
    __properties: ClassVar[List[str]] = ["object", "model", "b64"]

    @field_validator("object")
    def object_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["audio.tts.chunk"]):
            raise ValueError("must be one of enum values ('audio.tts.chunk')")
        return value
