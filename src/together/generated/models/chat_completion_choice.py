...
class ChatCompletionChoice(BaseModel):
    ...
    logprobs: Optional[LogprobsPart] = None
    delta: ChatCompletionChoiceDelta
    __properties: ClassVar[List[str]] = ["index", "finish_reason", "logprobs", "delta"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "logprobs": (
                    LogprobsPart.from_dict(obj["logprobs"])
                    if obj.get("logprobs") is not None
                    else None
                ),
                "delta": (
                    ChatCompletionChoiceDelta.from_dict(obj["delta"])
