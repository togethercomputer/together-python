...
class RerankResponseResultsInner(BaseModel):
    """
    ...
    document: RerankResponseResultsInnerDocument
    __properties: ClassVar[List[str]] = ["index", "relevance_score", "document"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "document": (
                    RerankResponseResultsInnerDocument.from_dict(obj["document"])
