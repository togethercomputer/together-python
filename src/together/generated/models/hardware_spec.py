...
class HardwareSpec(BaseModel):
    ...
    gpu_type: StrictStr = Field(description="The type/model of GPU")
    gpu_link: StrictStr = Field(description="The GPU interconnect technology")
    gpu_memory: Union[StrictFloat, StrictInt] = Field(
        description="Amount of GPU memory in GB"
    )
    gpu_count: StrictInt = Field(description="Number of GPUs in this configuration")
