...
class ImageResponse(BaseModel):
    ...
    model: StrictStr
    object: StrictStr
    data: List[Optional[ImageResponseDataInner]]
    __properties: ClassVar[List[str]] = ["id", "model", "object", "data"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": (
                    [ImageResponseDataInner.from_dict(_item) for _item in obj["data"]]
