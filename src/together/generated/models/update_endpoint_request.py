...
class UpdateEndpointRequest(BaseModel):
    ...
    state: Optional[StrictStr] = Field(
        default=None, description="The desired state of the endpoint"
    )
    autoscaling: Optional[Autoscaling] = Field(
        default=None, description="New autoscaling configuration for the endpoint"
    )
    __properties: ClassVar[List[str]] = ["display_name", "state", "autoscaling"]
