...
class HardwareApi:
    ...
    async def list_hardware(
        ...
        _param = self._list_hardware_serialize(
            model=model,
    ...
    @validate_call
    async def list_hardware_with_http_info(
        self,
        model: Annotated[
            Optional[StrictStr],
            Field(
    ...
    @validate_call
    async def list_hardware_without_preload_content(
        self,
        model: Annotated[
            Optional[StrictStr],
            Field(
