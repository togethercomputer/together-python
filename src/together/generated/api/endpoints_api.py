...
class EndpointsApi:
    ...
    async def delete_endpoint(
        ...
        endpoint_id: Annotated[
            StrictStr, Field(description="The ID of the endpoint to delete")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param endpoint_id: The ID of the endpoint to delete (required)
    ...
    async def get_endpoint(
        self,
        endpoint_id: Annotated[
            StrictStr, Field(description="The ID of the endpoint to retrieve")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param endpoint_id: The ID of the endpoint to retrieve (required)
        :type endpoint_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    async def list_endpoints(
        self,
        type: Annotated[
            Optional[StrictStr], Field(description="Filter endpoints by type")
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param type: Filter endpoints by type
        :type type: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    async def update_endpoint(
        self,
        endpoint_id: Annotated[
            StrictStr, Field(description="The ID of the endpoint to update")
        ],
        ...
        :param endpoint_id: The ID of the endpoint to update (required)
        :type endpoint_id: str
