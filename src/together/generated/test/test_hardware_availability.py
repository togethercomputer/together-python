...
class TestHardwareAvailability(unittest.TestCase):
    """HardwareAvailability unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HardwareAvailability:
        ...
        # uncomment below to create an instance of `HardwareAvailability`
        """
        model = HardwareAvailability()
        if include_optional:
    ...
    def testHardwareAvailability(self):
        """Test HardwareAvailability"""
