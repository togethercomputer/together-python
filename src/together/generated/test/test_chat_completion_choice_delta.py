...
class TestChatCompletionChoiceDelta(unittest.TestCase):
    """ChatCompletionChoiceDelta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatCompletionChoiceDelta:
        """Test ChatCompletionChoiceDelta
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ChatCompletionChoiceDelta`
        """
        model = ChatCompletionChoiceDelta()
        if include_optional:
            return ChatCompletionChoiceDelta(
                token_id = 56,
                role = 'system',
                content = '',
                tool_calls = [
    ...
    def testChatCompletionChoiceDelta(self):
        """Test ChatCompletionChoiceDelta"""
