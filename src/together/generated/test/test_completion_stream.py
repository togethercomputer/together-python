...
class TestCompletionStream(unittest.TestCase):
    """CompletionStream unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompletionStream:
        """Test CompletionStream
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CompletionStream`
        """
        model = CompletionStream()
        if include_optional:
