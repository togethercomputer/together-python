...
class TestChatCompletionMessageParam(unittest.TestCase):
    """ChatCompletionMessageParam unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChatCompletionMessageParam:
        """Test ChatCompletionMessageParam
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ChatCompletionMessageParam`
        """
        model = ChatCompletionMessageParam()
        if include_optional:
    ...
    def testChatCompletionMessageParam(self):
        """Test ChatCompletionMessageParam"""
