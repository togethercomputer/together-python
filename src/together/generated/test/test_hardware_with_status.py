...
class TestHardwareWithStatus(unittest.TestCase):
    """HardwareWithStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HardwareWithStatus:
        """Test HardwareWithStatus
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HardwareWithStatus`
        """
        model = HardwareWithStatus()
        if include_optional:
    ...
    def testHardwareWithStatus(self):
        """Test HardwareWithStatus"""
